...
\begin{tikzpicture}[align=center, node distance=1cm]
  ...
  \node (midi) [input, right = of bsn] {MIDI Controller};
  \node (mic1) [input, above = of midi] {Microphone};
  \node (mic2) [input, below = of midi] {Microphone};
  \node (int) [routing, right = of midi] {Audio Interface};
  ...
  \node (speaker5) [source, left = of speaker3] {Speaker};
  \node (speaker6) [source, left = of speaker4] {Speaker};
  \draw [cable] (bsn) |- (mic1);
  \draw [cable] (bsn) |- (mic2);
  ...
  \draw [cable] (int) -- (speaker5);
  \draw [cable] (int) -- (speaker6);
  \draw [cable] (midi) -- (int);
\end{tikzpicture}
