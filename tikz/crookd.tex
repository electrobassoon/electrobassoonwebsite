...
\begin{tikzpicture}[align=center,node distance = 1cm]
  ...
  \node (mixer) [routing, below= of interface] {Mixer};
  \node (speaker1) [source, left = of mixer] {Speaker};
  \node (speaker2) [source, right = of mixer] {Speaker};
  \draw [cable] (interface) -- (mixer);
