...
\node (mic1) [input, right = of bsn1, yshift = 1cm] {Microphone};
\node (mic2) [input, right = of bsn1, yshift = -1cm] {Microphone};
\node (interface1) [routing, right = of mic1, yshift = -1cm] {Audio Interface};
...
\draw [cable] (bsn1) |- (mic2);
\draw [cable] (mic1) -| (interface1.north west);
\draw [cable] (mic2) -| (interface1.south west);
