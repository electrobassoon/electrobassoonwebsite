...
\begin{tikzpicture}[align=center, node distance=1cm]
  ...
  \draw [cable] (bsn) |- (mic1);
  \draw [cable] (bsn) |- (mic2);
  \node (interface) [routing, right = of mic1, yshift = -1cm] {Mixer};
  ...
  \node (oct) [processor, right= of speaker1] {Octave Pedal};
  \node (del1) [processor, below= of oct] {Delay Pedal};
  \node (del2) [processor, below= of del1] {Delay Pedal};
  \draw [cable] (interface.north east) -- (oct);
  \draw [cable] (oct) -- (del1);
  \draw [cable] (del1) -- (del2);
  \draw [cable] (del2) -- (interface.south east);
\end{tikzpicture}
