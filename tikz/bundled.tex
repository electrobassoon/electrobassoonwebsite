...
\centering
  \begin{tikzpicture}[align=center, node distance=1cm]
    ...
    \node (wah) [processor, right = of preamp] {Wah Pedal};
    \node (dist) [processor, right = of wah] {Distortion Pedal};
    \node (chorus) [processor, right = of dist] {Chorus Pedal};
    \node (phaser) [processor, right = of chorus] {Phaser Pedal};
    \node (delay) [processor, right = of phaser] {Delay Pedal};
    \node (amp) [source, right = of delay] {Amp};
    \draw [cable] (bsn) -- (lj);
    \draw [cable] (lj) -- (preamp);
    \draw [cable] (preamp) -- (wah);
    \draw [cable] (wah) -- (dist);
    \draw [cable] (dist) -- (chorus);
    \draw [cable] (chorus) -- (phaser);
    \draw [cable] (phaser) -- (delay);
